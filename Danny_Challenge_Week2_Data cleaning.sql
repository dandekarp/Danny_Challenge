...
--adding identity columns to uniquely identify every single single pizza ordered
...
--Now, splitting the exclusions and extras comma delimited lists into rows and storing in new tables:

select record_id,
trim(value) as exclusions_ids
into ##exclusions
from ##customer_orders
cross apply string_split(eclusions,',')
